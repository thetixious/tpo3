...
//        driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
    ...
    public void test() throws InterruptedException {
        ...
        settingButton.click();
        WebElement pick = driver.findElement(By.xpath("//*[@id=\"i4\"]"));
        pick.click();
        WebElement soundPick = driver.findElement(By.xpath("//*[@id=\"ucj-1\"]/div[3]/div/div/div[2]/div[2]/button/span[2]"));
        soundPick.click();
        Thread.sleep(10000);
